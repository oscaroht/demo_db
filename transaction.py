...
class Transaction:
    ...
    def _get_or_create_shadow_table(self, table: Table):
        table_name = table.table_name
        if table_name in self.shadow_tables:
            return self.shadow_tables[table_name]
        return Table(table.table_name, table.column_names, table.column_datatypes, table.page_id)
